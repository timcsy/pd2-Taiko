...
QT_MOC_LITERAL(4, 37, 1) // "e"
    ...
    "UserWindow\0keyPressEvent\0\0QKeyEvent*\0"
    "e"
};
...
void UserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (UserWindow::*_t)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UserWindow::keyPressEvent)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void UserWindow::keyPressEvent(QKeyEvent * _t1)
{
