...
void Position::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Position::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Position::stop)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Position::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Position.data,
